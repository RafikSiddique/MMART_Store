...
class OrderModel {
  ...
  @override
  String toString() {
    return 'OrderModel(id: $id, orderAmount: $orderAmount, couponDiscountAmount: $couponDiscountAmount, couponDiscountTitle: $couponDiscountTitle, paymentStatus: $paymentStatus, orderStatus: $orderStatus, totalTaxAmount: $totalTaxAmount, paymentMethod: $paymentMethod, orderNote: $orderNote, orderType: $orderType, createdAt: $createdAt, updatedAt: $updatedAt, deliveryCharge: $deliveryCharge, scheduleAt: $scheduleAt, otp: $otp, pending: $pending, accepted: $accepted, confirmed: $confirmed, processing: $processing, handover: $handover, pickedUp: $pickedUp, delivered: $delivered, canceled: $canceled, refundRequested: $refundRequested, refunded: $refunded, deliveryAddress: $deliveryAddress, scheduled: $scheduled, storeDiscountAmount: $storeDiscountAmount, storeName: $storeName, storeAddress: $storeAddress, storePhone: $storePhone, storeLat: $storeLat, storeLng: $storeLng, storeLogo: $storeLogo, itemCampaign: $itemCampaign, detailsCount: $detailsCount, orderAttachment: $orderAttachment, moduleType: $moduleType, prescriptionOrder: $prescriptionOrder, customer: $customer, dmTips: $dmTips, processingTime: $processingTime, deliveryMan: $deliveryMan, taxStatus: $taxStatus)';
  }
}
